...
const adminMenuItems = [
  ...
  {
    path: "/dashboard/upcomingConsultant",
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "/dashboard/settings/termsAndCondition",
...
const Dashboard = ({ children }) => {
  ...
  const handleNotifications = () => {
    route.push("/dashboard/notifications");
  };

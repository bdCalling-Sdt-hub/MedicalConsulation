...
const AppointmentDetails = (props) => {
  ...
  //   const [addDocumentByDoctor] = useAddDocumentByAppointmentIdMutation();
  const [addDocumentByDoctor] = useAddDocumentByAppointmentIdByDoctorMutation();
          ...
          <Form.Item style={{ display: "flex", justifyContent: "flex-end" }}>
            <Button
              ...
              onClick={async () => {
                ...
                const res = await addDocumentByDoctor({
                  id: props.params.id,
                  data: formData,
                });

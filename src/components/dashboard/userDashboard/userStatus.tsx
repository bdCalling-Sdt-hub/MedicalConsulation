...
const UserStatus: React.FC = () => {
  ...
  return (
    <div className="bg-[#FFFFFF] p-6 rounded-xl">
      ...
      <div className="grid grid-cols-3 gap-8 w-[calc(100% -300px)] mt-[12px]">
      {cardData.map((card, index) => (
        <div
          key={card.id}
          className={`2xl:w-[450px] xl:w-[200px] lg:w-[150px] w-[450px] h-[210px] px-[20px] py-[32px] flex justify-between items-center rounded-2xl cursor-pointer ${
